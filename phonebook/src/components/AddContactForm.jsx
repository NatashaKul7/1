...
const AddContactForm = ({ addContact, isOpen, close }) => {
  ...
  return (
    ...
    >
      <div className="flex inset-0 bg-gray-500 bg-opacity-75"></div>
                ...
                >
                  ...
                  <div className="mb-2">
                    ...
                    <input
                      ...
                      className="w-full rounded px-3 py-2 text-gray-700 shadow"
                    />
                  </div>
                  <div className="mb-2">
                    <label
                  ...
                  <div className="px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                    ...
                    <button
                      ...
                      className="mt-3 w-full justify-center rounded-md border bg-white px-3 py-3 text-sm font-semibold text-gray-900 shadow-sm hover:bg-gray-50 sm:mt-0 sm:w-auto "
                    >
                      Cancel
                    </button>
                  </div>
