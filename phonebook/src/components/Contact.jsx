...
const Contact = ({ contact, removeContact }) => {
  ...
  return (
    <div className="bg-gray-50 flex w-full flex-col overflow-hidden rounded-md shadow shadow-neutral-300 sm:w-56">
     ...
     <div className="flex justify-evenly bg-indigo-50">
        ...
        <Icon
          ...
          type="link"
        />
        <Icon src={LinkIcon} alt="link" action={contact.website} type="link" />
        <Icon
          src={DeleteIcon}
          alt="delete"
